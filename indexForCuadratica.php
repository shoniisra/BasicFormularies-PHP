<html>
	<head>
		<title> Resolución de ecuaciones cuadráticas</title>
		<meta charset="utf-8">
		<link rel="stylesheet" type="text/css" href="css/forcuadratica.css">
	</head>
	<body>
		<header id="header" class="header_contenedor">
		<figure class="logotipo">
			<img src="images/espe_logo.png" height="100" alt="logo_espe">
